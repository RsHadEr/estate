    ...
    <div>
        {landLord&&(
            <div className="flex flex-col gap-2">
                ...
                <Link to={`mailto:${landLord.email}?subject=Regarding ${lisitng.name}&body=${message}`} className='bg-slate-700 text-white text-center p-3 uppercase rounded-lg hover:opacity'>Send Message</Link>
            </div>
        )}
